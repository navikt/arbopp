...
export interface MinoversiktSideProps {
    darkmode: boolean;
...
export function MinoversiktSide({ darkmode, setDarkmode }: MinoversiktSideProps) {
    ...
    return (
        <div className="side-storrelse" id={`side-storrelse_${id}`} data-testid={`side-storrelse_${id}`}>
            <ToppMeny erPaloggetVeileder={!visesAnnenVeiledersPortefolje} oversiktType={oversiktType} darkmode={darkmode} setDarkmode={setDarkmode} />
            ...
            <Innholdslaster avhengigheter={[statustallFetchStatus]}>
                ...
                >
                    ...
                    <div className="oversikt__container">
                        <div className={classNames('toolbar-container', { 'toolbar-container--scrolled': scrolling })}>
                            <div
                                className={classNames(
                                    'tabellinfo',
